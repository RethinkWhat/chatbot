...
class RAGPipeline:
    ...
    def get_ollama_stream(self, question: str):
        ...
        prompt = f"""
You are a helpful assistant. Use the documents below to answer the question. Keep your answers short and consise. Do not mention the context or the documents you are using as a basis.
...
Only use the documents to answer but do not mention which you used. If the answer is not found, say {apologyMsg}. 
